...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusBloggerBundle/issues).
...
License can be found [here](https://github.com/Sylius/SyliusBloggerBundle/blob/master/Resources/meta/LICENSE).
